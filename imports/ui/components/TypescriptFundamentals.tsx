...
const TypescriptFundamentalsPage = withLayout(Content, typescriptFundamentals);

const TypescriptFundamentals: React.FC = () => (
  <TypescriptFundamentalsPage
    title="TypeScript Fundamentals"
    description="content"
    sections={typescriptFundamentals}
  />
);
